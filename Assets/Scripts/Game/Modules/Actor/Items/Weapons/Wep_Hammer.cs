...
public class Wep_Hammer : Weapon
{
    ...
    [Header("Wep Position Armed")] [SerializeField]
    private Vector3 _ArmPositionFront;

    [SerializeField] private Vector3 _ArmRotationFront;


    [Header("Wep Position Start up")] [SerializeField]
    private Vector3 _StartupPositionFront;

    [SerializeField] private Vector3 _StartupRotationFront;

    [Header("Wep Position Attack")] [SerializeField]
    private Vector3 _AttackPositionFront;
