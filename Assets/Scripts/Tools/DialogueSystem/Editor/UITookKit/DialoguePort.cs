...
public class DialoguePort : Port {
    ...
    public class DefaultEdgeConnectorListener : IEdgeConnectorListener {
        ...
        public void OnDropOutsidePort(Edge edge, Vector2 position) {
            ...
            DialogueGraphView.searchWindow.DragPort = draggedPort as DialoguePort;
            DialogueGraphView.searchWindow.IsInputPort = draggedPort == edge.input;
            var mousePosition = DialogueGraphView.searchWindow.GraphView.Editor.position.position + position;
            SearchWindow.Open(new SearchWindowContext(mousePosition), DialogueGraphView.searchWindow);
        }
    ...
    public DialoguePort(Direction direction, Capacity capacity, List<string> styleClasses = null) : base(
